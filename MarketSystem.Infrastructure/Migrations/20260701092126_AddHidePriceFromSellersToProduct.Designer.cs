...
namespace MarketSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260701092126_AddHidePriceFromSellersToProduct")]
    partial class AddHidePriceFromSellersToProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketSystem.Domain.Entities.RegistrationRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MarketSystem.Domain.Entities.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MarketSystem.Domain.Entities.CashRegister", b =>
                {
                    ...
                    b.HasOne("MarketSystem.Domain.Entities.Market", "Market")
                        ...
                        .HasForeignKey("MarketSystem.Domain.Entities.CashRegister", "MarketId")
            ...
            modelBuilder.Entity("MarketSystem.Domain.Entities.RegistrationRequest", b =>
                {
                    b.HasOne("MarketSystem.Domain.Entities.Market", "CreatedMarket")
                        .WithMany()
                        .HasForeignKey("CreatedMarketId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MarketSystem.Domain.Entities.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MarketSystem.Domain.Entities.User", "ProcessedByUser")
                        .WithMany()
