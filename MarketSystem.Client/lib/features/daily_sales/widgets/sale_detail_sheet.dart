...
class _SaleDetailSheetState extends State<SaleDetailSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final items =
        (widget.saleDetails['items'] as List<dynamic>? ??
        widget.saleDetails['saleItems'] as List<dynamic>? ??
        const []);
    final sellerName =
        (widget.saleDetails['sellerName'] as String?) ?? widget.sale.sellerName;
    final l10n = AppLocalizations.of(context)!;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...items.map(
                    (item) => _buildProductItem(context, item, l10n),
                  ),
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(
                DateFormat('dd.MM.yyyy HH:mm').format(widget.sale.createdAt),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('$qty × $unitPrice', style: AppTextStyles.bodySmall()),
                  ],
                ),
              ),
              Text(
    ...
    return Container(
      ...
      child: Column(
        children: [
          _totalRow(
            l10n.totalSum,
            '${widget.sale.totalAmount} ${l10n.currencySom}',
            Colors.white,
          ),
